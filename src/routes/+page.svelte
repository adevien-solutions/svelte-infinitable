<script lang="ts">
	...
	import { ExampleTable } from '$lib/example/index.js';
</script>
...
<div class="prose mx-auto text-center prose-p:text-balance">
	...
	<p>
		...
		supports <em>infinite scrolling</em>, <em>searching</em>, <em>filtering</em>,
		<em>sorting</em>, and more.
	</p>
	<p>
		It integrates seamlessly into any project that uses <a
			href="https://shadcn-svelte.com/"
			target="_blank">shadcn</a
		>
		components, but it's flexible and customizable enough to fit the needs of any project.
	</p>
</div>
<div class="mt-10">
	<ExampleTable />
