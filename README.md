...
| `actions`            | `{ selectedCount: number }`                                                         | A slot above the table, but within it's border. It's the recommended place to mount the `Search`, `Refresh`, `FilterClear`, and any other custom components. |
